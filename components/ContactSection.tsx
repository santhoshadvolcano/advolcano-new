...
export default function ContactSection() {
  return (
    <section className="py-12 sm:py-20 bg-gradient-to-br from-yellow-50 via-orange-50 to-red-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="mt-12 sm:mt-16 text-center">
          ...
          <div className="flex justify-center flex-wrap gap-4">
            <a href="#" className="w-12 h-12 flex items-center justify-center bg-gradient-to-r from-green-500 to-teal-500 text-white rounded-full hover:from-green-600 hover:to-teal-600 transition-all cursor-pointer shadow-lg">
              <i className="ri-whatsapp-line w-6 h-6 flex items-center justify-center"></i>
            </a>
            <a href="#" className="w-12 h-12 flex items-center justify-center bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-full hover:from-blue-600 hover:to-cyan-600 transition-all cursor-pointer shadow-lg">
              <i className="ri-telegram-line w-6 h-6 flex items-center justify-center"></i>
            </a>
            <a href="#" className="w-12 h-12 flex items-center justify-center bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full hover:from-purple-600 hover:to-pink-600 transition-all cursor-pointer shadow-lg">
            ...
            <a href="#" className="w-12 h-12 flex items-center justify-center bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-full hover:from-blue-700 hover:to-indigo-700 transition-all cursor-pointer shadow-lg">
            ...
            <a href="#" className="w-12 h-12 flex items-center justify-center bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-full hover:from-red-600 hover:to-pink-600 transition-all cursor-pointer shadow-lg">
