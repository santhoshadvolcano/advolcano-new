...
export default function PaymentOptions() {
  const paymentMethods = [
    ...
    { name: 'USDT', icon: 'ri-coins-line', description: 'Tether cryptocurrency payments' },
    { name: 'Bitcoin', icon: 'ri-bit-coin-line', description: 'Bitcoin cryptocurrency payments' },
    { name: 'Credit Card', icon: 'ri-bank-card-line', description: 'Visa, MasterCard, American Express' }
  ];
